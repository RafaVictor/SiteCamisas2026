        ...
        <>
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-border">
              <h2 className="font-display font-bold text-lg text-card-foreground">Carrinho</h2>
            ...
            {items.length === 0 ? (
              ...
              <>
                ...
                <div className="p-4 border-t border-border space-y-4">
                  <div className="flex justify-between font-display font-bold text-lg text-card-foreground">
                    <span>Total</span>
